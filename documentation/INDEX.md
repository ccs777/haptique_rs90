...
- **[FILES_FOR_GITHUB.md](FILES_FOR_GITHUB.md)** - File structure for GitHub repository
- **[GIT_COMMANDS.md](GIT_COMMANDS.md)** - Git commands for releasing
...
2. Or download latest release from [Releases](https://github.com/daangel27/haptique_rs90/releases)
